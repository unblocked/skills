...
seen before. Use alongside the main workflow (SKILL.md) to hydrate Phase 1.
...
Capture: system boundaries, key abstractions, data flow, integration points.
...
Key files to identify: entry points, core logic, data layer, config, tests.
...
Watch for: ADRs, rejected alternatives, known tech debt, recent direction changes / mid-migration state.
